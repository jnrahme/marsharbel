...
for htmlfile in *.html; do
  ...
  # pio-story.html, jpii-story.html = inbound Story dropdown + saint-page cross-links ship with the content lane's nav re-sync after prayer-hub
  case "$htmlfile" in
    google*.html|index.html) continue ;;
    mystery-meditation.html|rosary-source-text.html|testimony-review.html|voice-lab.html|souvenirs.html|pio-story.html|jpii-story.html) continue ;;
  esac
